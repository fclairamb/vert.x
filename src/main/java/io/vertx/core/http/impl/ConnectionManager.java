...
public class ConnectionManager {
  ...
  public class ConnQueue {
    ...
    ConnQueue(HttpVersion version, QueueManager mgr, TargetAddress address) {
      ...
      this.mgr = mgr;
      this.metrics = ConnectionManager.this.metrics.createConnectionQueue(address.host, address.port);
    ...
    public synchronized void connectionClosed() {
      ...
      if (waiter != null) {
        ...
        if (ConnectionManager.this.metrics.isEnabled()) {
          ConnectionManager.this.metrics.closeConnectionQueue(address.host, address.port, metrics);
        }
      }
    }
